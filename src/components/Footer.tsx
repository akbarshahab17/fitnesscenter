      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md mb-6">
              Islamabad's premier fitness destination. Transform your body and life 
              with our state-of-the-art facilities and expert guidance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li>Sector H, Bahria Enclave</li>
              <li>Islamabad, Pakistan</li>
              <li>
                <a href="tel:03185576657" className="hover:text-primary transition-colors">
                  0318 5576657
                </a>
              </li>
              <li>
                <a href="mailto:info@thefitnesscentre.pk" className="hover:text-primary transition-colors">
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            © {currentYear} The Fitness Centre. All rights reserved.
          </p>
